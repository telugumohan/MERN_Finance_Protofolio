...
const UserCard7 = ({ userDetails }) => {
  return (
    <div>
      <div className="flex justify-start items-center min-w-sm max-w-sm h-56 bg-green-600 rounded-2xl p-2 shadow-2xl shadow-green-800">
        ...
        <div className="flex-1 flex flex-col justify-center items-start gap-4 px-4 py-3 h-full rounded-2xl">
          ...
          <p className="text-gray-200 text-lg">{userDetails.gender}</p>
          <p className="text-gray-200 text-lg">{userDetails.phone}</p>
        </div>
      </div>
    </div>
  );
